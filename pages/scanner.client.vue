<template>
  ...
  <div>
    ...
    <div class=" relative   bg-slate-400  border-black border-4  w-screen h-screen  ">
...
onMounted(async () => {
  ...
  if (devices.value.length > 0) {
    selectedDevice.value = devices.value.find(device => device.label.includes('back')) || devices.value[0];
  }
})
